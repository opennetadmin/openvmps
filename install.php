...
$plugin_name = 'openvmps';

// Set a title
$window['title'] = "OpenVMPS Tools Install";
...
//
$pmodules = array();
$pmodules['openvmps_lookup']['desc'] = 'Lookup MAC to VLAN associations for OpenVMPS';

// Provide a list of permissions to add for this plugin
//$ppermissions['puppet_ext_node_admin']['desc'] = 'Administer puppet external node data';
